...
public class AESUtils {
    ...
    public static void main(String[] args) {
        File file = new File("/Users/jiajunmei/Desktop/crato-master/D:/export/upload/20210506/2.txt");
        byte[] bytesByFile = getBytesByFile(file);
        byte[] decrypt = decrypt(bytesByFile, "1234567890abcdef");
        getFileByBytes(decrypt ,"/Users/jiajunmei/Desktop/","e.txt");
    }
}
